...
6. **render_page** — 将内容渲染为 HTML 页面并在浏览器打开。有两种模式：
   ...
   仅在内容有展示价值时使用（总结报告、多维分析、决策对比、路线图等），日常回复不需要。
7. **search_wisdom** — 检索成功人士（马斯克、乔布斯、马云、纳瓦尔、巴菲特、芒格等）的真实价值观、核心理念和行动指南。当给用户建议时可以引用相关人物的真实经验来丰富指导。**建议在 analyze_situation 或 analyze_decision 之后调用**，找到与用户处境相通的人物智慧来增强建议的说服力。
